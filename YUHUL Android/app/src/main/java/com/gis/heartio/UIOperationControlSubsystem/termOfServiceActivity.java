...
public class termOfServiceActivity extends AppCompatActivity {
    ...
    private Button mDisagreeBtn, mAgreeBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisagreeBtn = findViewById(R.id.disagreeBtn);
        mAgreeBtn = findViewById(R.id.agreeBtn);
        ...
        mAgreeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(termOfServiceActivity.this, registerActivity.class);
