...
abstract public class SampleFragment extends Fragment {
    ...
    protected void stopFragment() {
        DecoView arcView = getHRDecoView();

        if (!(arcView == null || arcView.isEmpty())) {
            arcView.executeReset();
            arcView.deleteAll();
        }
        arcView = getVpkDecoView();
        ...
        arcView = getVtiDecoView();
        if (!(arcView == null || arcView.isEmpty())) {
            arcView.executeReset();
            arcView.deleteAll();
        }

        arcView = getSvDecoView();
        if (!(arcView == null || arcView.isEmpty())) {
            arcView.executeReset();
            arcView.deleteAll();
        }

        arcView = getCoDecoView();
        if (!(arcView == null || arcView.isEmpty())) {
            arcView.executeReset();
            arcView.deleteAll();
        }
    ...
    protected DecoView getHRDecoView() {
        if (getView() == null) {
            return null;
        }
    ...
    protected DecoView getVpkDecoView() {
        if (getView() == null) {
            return null;
        }
    ...
    protected DecoView getVtiDecoView() {
        if (getView() == null) {
            return null;
        }
    ...
    protected DecoView getSvDecoView() {
        if (getView() == null) {
            return null;
        }
    ...
    protected DecoView getCoDecoView() {
        if (getView() == null) {
            return null;
        }
