...
public class Constants {
    ...
    public static final String EXTRA_UDI_VALUE = "com.gis.heartio." +
            "EXTRA_UDI_PARA_VALUE";
    /**
     * Links
     */
     ...
     * Fragment Tags
     */
    public static String TEST_SETTING_FRAGMENT_TAG = "Test Setting";
    public static String PROFILE_SCANNING_FRAGMENT_TAG = "BLE Devices";
    public static String USER_INFO_SETTING_FRAGMENT_TAG = "User Info. Setting";
    public static String LONG_START_SETTING_FRAGMENT_TAG = "Long Start Setting";
    public static String USER_MANAGER_TAG = "User Manager";
    public static String ADMIN_MANAGER_TAG = "Admin Manager";
    public static String USER_ADD_EDIT_TAG = "User Add & Edit";
    public static String FILEOPEN_TAG = "File Open";
    public static String DATA_MANAGER_TAG = "Data Manager";
    public static String DATA_MANAGER_TREND_TAG = "Data Manager Trend";
    ...
    public static String MORE_FRAGMENT_TAG = "More";
    public static String INTERVAL_FRAGMENT_TAG = "Interval";

    public static String ITRI_ULTRASOUND_FRAGMENT_TAG = "ITRI Wearable Ultrasound";
    public static String APP_START_FRAGMENT_TAG = "Application Start";
    public static String APP_ABOUT_FRAGMENT_TAG = "About";
    /**
