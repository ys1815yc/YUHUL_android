...
public class UUIDDatabase {
    ...
    //added by brandon
    public final static UUID UUID_ULTRASOUND_DATA_SERVICE = UUID
            .fromString(GattAttributes.ULTRASOUND_DATA_SERVICE);
    public final static UUID UUID_ULTRASOUND_DATA_CHARACTERISTIC = UUID
            .fromString(GattAttributes.ULTRASOUND_DATA_CHARACTERISTIC);
    public final static UUID UUID_ULTRASOUND_GAIN_CONTROL_SERVICE = UUID
            .fromString(GattAttributes.ULTRASOUND_GAIN_CONTROL_SERVICE);
    public final static UUID UUID_ULTRASOUND_GAIN_CONTROL_CHARACTERISTIC = UUID
            .fromString(GattAttributes.ULTRASOUND_GAIN_CONTROL_CHARACTERISTIC);
    public final static UUID UUID_ULTRASOUND_ANGLE_ESTIMATE_SERVICE = UUID
            .fromString(GattAttributes.ULTRASOUND_ANGLE_ESTIMATE_SERVICE);
    public final static UUID UUID_ULTRASOUND_ANGLE_ESTIMATE_CHARACTERISTIC = UUID
            .fromString(GattAttributes.ULTRASOUND_ANGLE_ESTIMATE_CHARACTERISTIC);

    //add by Cavin
    public final static UUID UUID_HEARTIO_DATA_SERVICE = UUID
            .fromString(GattAttributes.HEARTIO_DATA_SERVICE);
    public final static UUID UUID_HEARTIO_DATA_CHARACTERISTIC = UUID
            .fromString(GattAttributes.HEARTIO_DATA_CHARACTERISTIC);
    public final static UUID UUID_HEARTIO_GAIN_CHARACTERISTIC = UUID
            .fromString(GattAttributes.HEARTIO_GAIN_CHARACTERISTIC);
    public final static UUID UUID_HEARTIO_UDI_PARA_CHARACTERISTIC = UUID
            .fromString(GattAttributes.HEARTIO_UDI_PARA_CHARACTERISTC);

    // For HeartIO2
    public final static UUID UUID_HEARTIO2_RUNCMD_CHARACTERISTIC = UUID
            .fromString(GattAttributes.SP_CHAR3_STRING_UUID);
    public final static UUID UUID_HEARTIO2_DATA_CHARACTERISTIC = UUID
            .fromString(GattAttributes.SP_CHAR6_STRING_UUID);

    public final static ParcelUuid PARCEL_UUID_ULTRASOUND_DATA_SERVICE =
            ParcelUuid.fromString(GattAttributes.ULTRASOUND_DATA_SERVICE);
    public final static ParcelUuid PARCEL_UUID_ULTRASOUND_DATA_CHARACTERISTIC =
            ParcelUuid.fromString(GattAttributes.ULTRASOUND_DATA_CHARACTERISTIC);
    public final static ParcelUuid PARCEL_UUID_ULTRASOUND_GAIN_CONTROL_SERVICE =
            ParcelUuid.fromString(GattAttributes.ULTRASOUND_GAIN_CONTROL_SERVICE);
    public final static ParcelUuid PARCEL_UUID_ULTRASOUND_GAIN_CONTROL_CHARACTERISTIC =
            ParcelUuid.fromString(GattAttributes.ULTRASOUND_GAIN_CONTROL_CHARACTERISTIC);
    public final static ParcelUuid PARCEL_UUID_ULTRASOUND_ANGLE_ESTIMATE_SERVICE =
            ParcelUuid.fromString(GattAttributes.ULTRASOUND_ANGLE_ESTIMATE_SERVICE);
    public final static ParcelUuid PARCEL_UUID_ULTRASOUND_ANGLE_ESTIMATE_CHARACTERISTIC =
            ParcelUuid.fromString(GattAttributes.ULTRASOUND_ANGLE_ESTIMATE_CHARACTERISTIC);

    public final static ParcelUuid PARCEL_UUID_HEARTIO_DATA_SERVICE =
            ParcelUuid.fromString(GattAttributes.HEARTIO_DATA_SERVICE);
    public final static ParcelUuid PARCEL_UUID_HEARTIO_DATA_CHRACTERISTIC =
            ParcelUuid.fromString(GattAttributes.HEARTIO_DATA_CHARACTERISTIC);
